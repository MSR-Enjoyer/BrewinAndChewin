...
public class BnCCraftingRecipes {
    ...
    private static void recipes(Consumer<FinishedRecipe> consumer) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, BnCItems.HAM_AND_CHEESE_SANDWICH.get(), 2)
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "ham_and_cheese_sandwich"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, BnCItems.PIZZA.get())
                ...
                .unlockedBy("has_cheese", InventoryChangeTrigger.TriggerInstance.hasItems(BnCItems.FLAXEN_CHEESE_WEDGE.get()))
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "pizza"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, BnCItems.QUICHE.get())
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "quiche_from_bacon"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, BnCItems.QUICHE.get())
                .pattern("blb")
                .pattern("mcm")
                .pattern("eCe")
                ...
                .define('C', ModItems.PIE_CRUST.get())
                .unlockedBy("has_crust", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.PIE_CRUST.get()))
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "quiche_from_mushroom"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BnCItems.COASTER.get(), 4)
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "item_coaster"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, BnCItems.PIZZA.get())
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "pizza_from_slices"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, BnCItems.FLAXEN_CHEESE_WHEEL.get())
                .pattern("pp")
                .pattern("pp")
                .define('p', BnCItems.FLAXEN_CHEESE_WEDGE.get())
                .unlockedBy("has_cheese", InventoryChangeTrigger.TriggerInstance.hasItems(BnCItems.FLAXEN_CHEESE_WEDGE.get()))
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "flaxen_cheese_wheel_from_wedges"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, BnCItems.SCARLET_CHEESE_WHEEL.get())
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "scarlet_cheese_wheel_from_wedges"));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, BnCItems.QUICHE.get())
                .pattern("pp")
                .pattern("pp")
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "quiche_from_slices"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BnCItems.KEG.get())
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "keg"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BnCItems.TANKARD.get(), 4)
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "tankard"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BnCItems.HEATING_CASK.get(), 1)
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "heating_cask"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BnCItems.ICE_CRATE.get(), 1)
                ...
                .save(consumer, new ResourceLocation(BrewinAndChewinNeoForge.MODID, "ice_crate"));
