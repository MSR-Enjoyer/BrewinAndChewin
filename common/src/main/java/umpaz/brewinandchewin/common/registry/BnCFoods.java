...
public class BnCFoods {
    ...
    public static final FoodProperties VODKA = (new FoodProperties.Builder())
            ...
            .effect(new MobEffectInstance(BnCEffects.INTOXICATION, 3000, 0), 1.0F)
            .alwaysEdible()
            .build();
    public static final FoodProperties MEAD = (new FoodProperties.Builder())
            .effect(new MobEffectInstance(BnCEffects.TIPSY, 2400, 0), 1.0F)
            .effect(new MobEffectInstance(BnCEffects.INTOXICATION, 1800, 0), 1.0F)
            .effect(new MobEffectInstance(BnCEffects.SWEET_HEART, 2400, 0), 1.0F)
            .alwaysEdible()
            .build();
    ...
    public static final FoodProperties SACCHARINE_RUM = (new FoodProperties.Builder())
            ...
            .effect(new MobEffectInstance(BnCEffects.INTOXICATION, 2400, 0), 1.0F)
            .effect(new MobEffectInstance(BnCEffects.SWEET_HEART, 3600, 0), 1.0F)
            .alwaysEdible()
            .build();
    ...
    public static final FoodProperties DREAD_NOG = (new FoodProperties.Builder())
            ...
            .effect(new MobEffectInstance(BnCEffects.INTOXICATION, 4200, 0), 1.0F)
    ...
    public static final FoodProperties FIERY_FONDUE = (new FoodProperties.Builder())
            ...
            .effect(new MobEffectInstance(ModEffects.COMFORT, 8400, 0), 1.0F).build();
    ...
    public static final FoodProperties SCARLET_PIEROGIES = (new FoodProperties.Builder())
            ...
            .effect(new MobEffectInstance(ModEffects.NOURISHMENT, 8400, 0), 1.0F).build();
