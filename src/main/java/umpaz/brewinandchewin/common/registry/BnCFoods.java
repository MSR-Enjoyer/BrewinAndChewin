...
public class BnCFoods {
    public static final FoodProperties BEER = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(BnCEffects.TIPSY.get(), 9600, 0), 1.0F)
    ...
    public static final FoodProperties RICE_WINE = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATION.get(), 1500, 0), 1.0F)
    ...
    public static final FoodProperties STRONGROOT_ALE = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(BnCEffects.TIPSY.get(), 14400, 1), 1.0F)
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATION.get(), 3600, 0), 1.0F)
    ...
    public static final FoodProperties SALTY_FOLLY = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(BnCEffects.TIPSY.get(), 12000, 1), 1.0F)
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATION.get(), 1500, 0), 1.0F)
    ...
    public static final FoodProperties WITHERING_DROSS = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(BnCEffects.TIPSY.get(), 24000, 2), 1.0F)
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATION.get(), 6000, 0), 1.0F)
